...
public class AIOTRegistry {
    ...
    public static final Item copperAiot = AIOTRegistry.makeItem(List.of(CompatHelper.SIMPLEST_COPPER_GEAR, CompatHelper.MOREVANILLATOOLS), 0, -2.4F, ToolMaterials.COPPER, new Item.Properties());
    ...
    public static final Item skyjadeAiot = AIOTRegistry.makeItem(CompatHelper.DEEP_AETHER, 6, -2.4F, ToolMaterials.SKYJADE, new Item.Properties());
